...
export default function PeoplePage() {
  ...
  useEffect(() => {
    ...
    // Auth separately — just for filtering self and presence
  ...
  return (
    <div className="min-h-screen text-white" style={{ background: 'linear-gradient(135deg, #0a0a0f 0%, #0d0d1a 100%)' }}>
      <div style={{ background: 'rgba(255,255,255,0.02)', borderBottom: '1px solid rgba(255,255,255,0.05)' }} className="px-4 py-4">
        <div className="max-w-xl mx-auto flex justify-between items-center">
          <div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-gray-600 text-xs">· {filtered.length} total</span>
            </div>
          </div>
